...
public class HealthBar extends Actor
{
    ...
    private void newImage()
    {
        ...
        if (value > minimumValue)
        {
            ...
            if (value == colorController)
            {
                int redColor = ((safeColor.getRed() + dangerColor.getRed()) / 2);
                int greenColor = ((safeColor.getGreen() + dangerColor.getGreen()) / 2);
                int blueColor = ((safeColor.getBlue() + dangerColor.getBlue()) / 2);
                barImg.setColor(new Color(redColor, greenColor, blueColor));
            }
