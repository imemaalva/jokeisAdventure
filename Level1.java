...
public class Level1 extends ScrollingWorld
{
    ...
    public Level1(int characterId)
    {
        ...
        addObject(new Jokeis(), 16+BLOCK_SIZE*40, WORLD_HEIGHT-(BLOCK_SIZE/2)-BLOCK_SIZE*2);
        addObject(new Jokeis(), 16+BLOCK_SIZE*118, WORLD_HEIGHT-(BLOCK_SIZE/2)-BLOCK_SIZE*5);
        addObject(new Jokeis(), 16+BLOCK_SIZE*175, WORLD_HEIGHT-(BLOCK_SIZE/2)-BLOCK_SIZE*6);
